<script>
    /*
     Sanjaya Senevirathne Modification ARMSL QLINTs
     */
    ...
    Vvveb.Builder = {
                    ...
                    for (i in components)
                    {
                        ...
                        if (component)
                        {
                            ...
                            if (component.image) {
                                ...
                                item.css({
                                    backgroundImage: "url({{url('/')}}/" + 'QulintMaster/libs/builder/' + component.image + ")",
        ...
        saveAjax: function(fileName, startTemplateUrl, callback)
        {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('frontend.user.qulint_builder.save_page')}}',//set your server side save script url
                data: data,
                cache: false,
